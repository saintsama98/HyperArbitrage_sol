...
describe("Lock", function () {
    ...
    describe("Deployment", function () {
        ...
        it("Should receive and store the funds to lock", async function () {
            ...
            (0, chai_1.expect)(await hardhat_1.default.ethers.provider.getBalance(lock.address)).to.equal(lockedAmount);
        });
        ...
        describe("Events", function () {
            it("Should emit an event on withdrawals", async function () {
                ...
                await (0, chai_1.expect)(lock.withdraw())
                    ...
                    .withArgs(lockedAmount, withArgs_1.anyValue); // We accept any value as `when` is difficult to predict
            });
        });
